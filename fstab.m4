...
/dev/block/platform/msm_sdcc.3/by-num/p14         /system      f2fs    rw,discard,nosuid,nodev,noatime,nodiratime,inline_xattr wait
/dev/block/platform/msm_sdcc.3/by-num/p20         /data        ext4    nosuid,nodev,noatime,barrier=1,noauto_da_alloc,errors=continue      check
/dev/block/platform/msm_sdcc.3/by-num/p20         /data        f2fs    rw,discard,nosuid,nodev,noatime,nodiratime,inline_xattr  check
...
/dev/block/platform/msm_sdcc.3/by-num/p16         /cache       f2fs    rw,discard,nosuid,nodev,noatime,nodiratime,inline_xattr wait,check
